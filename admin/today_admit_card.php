...
if(!isset($_SESSION['super_admin'])) {   
  ...
  $admit_card_quary = "SELECT admit_card.id, admit_card.exam_venu,admit_card.admit_submit_date,admit_card.post_job_id, company_profile.id,company_profile.Company_Name,my_profile.Main_id as myid , my_profile.First_Name,my_profile.Last_Name,my_profile.Photo  FROM   admit_card
    ...
    WHERE admit_card.admit_submit_date = '$date' LIMIT $start_from, $per_page  ";


  $today_admit_card_result = mysqli_query($conn, $admit_card_quary);
   
  $admit_card_count = mysqli_num_rows($today_admit_card_result );
...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Today Admitcard Submit <?php echo $admit_card_count ; ?></h1>
      <ol class="breadcrumb">
        <li><a href="index">Home</a></li>
    <li class="sub-bread"><i class="fa fa-angle-right"></i> Company</li>
        <li><i class="fa fa-angle-right"></i> Today Admitcard</li>
      </ol>
    </section>
    ...
    <section class="content"> 
      ...
      <div class="row">
        ...
        <?php  while( $today_admit_card_row = mysqli_fetch_array($today_admit_card_result) ){ 

          $id =  $today_admit_card_row['post_job_id'];
          // job type quarye
          include 'db_connet.php';
         ...
         ?>
                      <tr>
                        <td><?php echo $today_admit_card_row['id']?></td>
                        <td><img src="../photo/<?php echo $today_admit_card_row['Photo']?>" class="img-circle img-w-30" alt="User Image"> 

                          <a href="../profile_view?id=<?php echo $today_admit_card_row['myid']; ?> " target= "_blank">

                            <?php echo $today_admit_card_row['First_Name']." ". $today_admit_card_row['Last_Name']?></a></td>
                        <td><a href="../company_view?com_id=<?php echo $today_admit_card_row['id'] ?> " target='_blank'><?php echo $today_admit_card_row['Company_Name']?></a></td>
                        <td><?php echo $job_title_row['Job_Title']?></td>
                        <td><?php echo $today_admit_card_row['exam_venu']?></td>
                        <td><a href="today_admit_card?action=delete&id=<?php echo $today_admit_card_row['id']  ?>" onclick="return confirm('Are you sure you want to delete this item?'); "><button type="button" class="btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a></td>
                        <td><?php echo $today_admit_card_row['admit_submit_date']?></td>
                      </tr>
                      <tr>
      <?php } ?>
                    </tbody>                    
