...
if(!isset($_SESSION['super_admin'])) {   
  ...
  $page_class = 'total_applied';
    ...
    $total_applied = "DELETE FROM applied_job  WHERE id =$id ";  

      if(mysqli_query($conn, $total_applied)){

      header("location: total_applied");
  ...
  INNER JOIN post_jobs  ON  applied_job.post_jobs_id = post_jobs.id 
...
<?php include('menu.php');   ?>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Total Applied <?php echo $total_applied ; ?></h1>
      <ol class="breadcrumb">
        <li><a href="index">Home</a></li>
		<li class="sub-bread"><i class="fa fa-angle-right"></i> Candidate</li>
        <li><i class="fa fa-angle-right"></i> Total Applied</li>
      </ol>
    </section>
...
$job_title_quarry = "SELECT * FROM my_resume  WHERE Main_id =  $my_profile_id";
...
$job_title_row  = mysqli_fetch_array($job_title_result);
  ...
  ?>
                       ...
                       <tr>
                        ...
                        <td><?php echo $job_title_row['Tittle'] ; ?></td>
