...
if(!isset($_SESSION['super_admin'])) {   
  ...
  $page_class = 'today_job_post';
    ...
    $total_job_post = "DELETE FROM post_jobs WHERE id =$id ";  
      ...
      header("location: today_job_post");
...
// Pagination.............
  ...
  $previouspage =  $page - 1;
    ...
    $today_job_post_quary = "SELECT * FROM  post_jobs WHERE Job_Created_Date = '$date' ORDER BY id  LIMIT $start_from, $per_page ";

    $today_job_post_result = mysqli_query($conn, $today_job_post_quary);
   
    $today_job_post = mysqli_num_rows($today_job_post_result); 
 ...
 <?php  include('menu.php') ?>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Today Job Post <?php echo $today_job_post ; ?></h1>
      <ol class="breadcrumb">
        <li><a href="index">Home</a></li>
    <li class="sub-bread"><i class="fa fa-angle-right"></i> Company</li>
        <li><i class="fa fa-angle-right"></i> Today Job Post</li>
      </ol>
    </section>
        ...
        <div class="col-lg-12">
          <div class="info-box">
            <div class="row">
              ...
              <?php  while($today_job_post_row = mysqli_fetch_array($today_job_post_result) ){  
              
                $id =$today_job_post_row['Main_id'];
                include  "db_connet.php";
             ...
             ?>
                      <tr>
                        <td><?php echo $today_job_post_row['id']; ?> </td>
                        ...
                        <td><?php echo $today_job_post_row ['Job_Title'] ; ?></td>
                        <td><?php echo $today_job_post_row ['Job_Location'] ; ?></td>
                        <td><?php echo $today_job_post_row ['Qualification'] ; ?></td>
                        <td> <a href="today_job_post?action=delete&id=<?php echo $today_job_post_row['id']  ?>" onclick="return confirm('Are you sure you want to delete this item?'); "><button type="button" class="btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a> </td>
                        <td><?php echo $today_job_post_row ['Job_Created_Date'] ; ?></td>
                      </tr>
