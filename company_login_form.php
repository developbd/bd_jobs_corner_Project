...
<section id="registration-area">
  <div class="container">
    ...
    <div class="row">
             ...
             <div class="reg-title-social-icon">
              <ul>
                 <li><i class="fa fa-map-marker" aria-hidden="true"></i>
                  ...
                  <li>
                  <form method="post" action="registration_form_company">
        ...
        <h2>Company Login Here</h2>
          <hr>
      </div>
	  

<form class="form-horizontal" method="Post" action="company_login_form_action.php">
  ...
  <div class="form-group inputwith-icon">
      <input type="password" class="form-control my-form-cntrl col-sm-9"  name="pass" id="inputPassword" placeholder="Password">
      <i class="fa fa-eye" aria-hidden="true" onclick="pass_show()"></i> 
  </div>
  
  <div class="form-group form-inline">
   <a href="forgot_password?type=company"class="btn btn-link"> Forgot password? </a>
  </div>
...
<!----
 ...
 <div class="signup-facebook">
        <h2>Sine up with Facebook</h2>
        <div class="facebook-btn">
        <button type="button" class="btn btn-default my-facebookbtn"><i class="fa fa-facebook" aria-hidden="true"></i>Sign up with facebook</button>
        </div>
      </div>
         </div>
        </div><!----
