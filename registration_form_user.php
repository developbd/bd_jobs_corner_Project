                  ...
                  <div class="reg-leftsid">
                     ...
                     <div class="reg-title-social-icon">
                        <ul>
                           ...
                           <li>
                              <form method="post" action="user_login_form.php" >
                     ...
                     <form class="form-horizontal" enctype="multipart/form-data"  action="" id="frmFormMail" name="frmFormMail"  method="post"  onsubmit=" return checkall()" >
                        <div class="set-min-height">
                           <div class="form-group inputwith-icon">
                              <input type="text" class="form-control my-form-cntrl col-sm-9" id="name" name="full_name" placeholder="User Name" required  >
                              <i class="fa fa-user" aria-hidden="true"></i>
                           </div>
                        </div>
                        <div class="set-min-height"  >
                          <div class="form-group form-inline">
                            <div class="radio my-radiobtn col-sm-9">
                        ...
                        <div class="form-group">
                           <button type="submit" name="user_submit" id="btn";" class="btn btn-default">Ragistration Now</button>
                        </div>
                     </form>
                  </div>
               </div>
