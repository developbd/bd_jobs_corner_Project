...
header("location: company_login_form.php");
	...
	<div class="container">
        ...
        <div class="canditate_area">
          ...
          <h3><?php echo  $profile_name; ?></h3>         
            ...
            <li class="active" ><a href="change_pass_company">Change Password</a></li>
                                        ...
                                        <div class="col-md-6">
                                           ...
                                           <div class="col-md-12">
                                              <div class="btn-form-control">
                                                 <button type="submit" name="company_change_pass_submit" class="das-btn">Save</button>
